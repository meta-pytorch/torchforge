...
def inputs():
    ...
    ratio, log_ratio, _ = compute_ratio(logprobs, inference_logprobs, loss_mask)
...
class TestPrimitives:
    ...
    def test_compute_ratio_token(self, inputs):
        ...
        ratio, log_ratio, _ = compute_ratio(
            logprobs, d["inference_logprobs"], d["loss_mask"], ratio_type="token"
        )
    ...
    def test_compute_ratio_sequence(self, inputs):
        ...
        logprobs = d["logprobs"].clone().requires_grad_(True)
        ratio, log_ratio, _ = compute_ratio(
            logprobs, d["inference_logprobs"], d["loss_mask"], ratio_type="sequence"
        )
...
class TestLosses:
    ...
    def test_grpo(self, inputs):
        ...
        output = loss_fn(
            ...
            inference_logprobs=d["inference_logprobs"],
    ...
    def test_empty_sequence(self, loss_cls, kwargs):
        ...
        inference_logprobs = torch.empty(B, 0)
